...
public class F8 {
    public static void main(String[] args) {
        double t = Double.parseDouble(JOptionPane.showInputDialog("INGRESA UNA CANTIDAD DE GRADOS: "));
        double t1=temperatura((int) t,1);
        double t2=temperatura((int) t,2);
        System.out.println(t1+" °FARENHEIT");
        System.out.println(t2+" °KELVIN");
    }
    //FUNCION QUE REALICE LA CONVERSION DE CELSIUS A FARENHEIT O KELVIN
    //X ES LA CANTIDAD DE GRADOS
    //Y OPCION DE CONVERSION
